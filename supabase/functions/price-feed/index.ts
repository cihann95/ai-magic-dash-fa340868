...
const SYMBOLS: SymRef[] = [
  ...
  { symbol: "DOTUSD", asset_class: "crypto", binance: "DOTUSDT" },
  { symbol: "LINKUSD", asset_class: "crypto", binance: "LINKUSDT" },
  { symbol: "MATICUSD", asset_class: "crypto", binance: "MATICUSDT" },
  { symbol: "UNIUSD", asset_class: "crypto", binance: "UNIUSDT" },
  { symbol: "ATOMUSD", asset_class: "crypto", binance: "ATOMUSDT" },
  { symbol: "TRXUSD", asset_class: "crypto", binance: "TRXUSDT" },
  { symbol: "LTCUSD", asset_class: "crypto", binance: "LTCUSDT" },
  { symbol: "FILUSD", asset_class: "crypto", binance: "FILUSDT" },
  { symbol: "BCHUSD", asset_class: "crypto", binance: "BCHUSDT" },
  { symbol: "ETCUSD", asset_class: "crypto", binance: "ETCUSDT" },
  { symbol: "XLMUSD", asset_class: "crypto", binance: "XLMUSDT" },
  { symbol: "ICPUSD", asset_class: "crypto", binance: "ICPUSDT" },
  { symbol: "NEARUSD", asset_class: "crypto", binance: "NEARUSDT" },
  { symbol: "APTUSD", asset_class: "crypto", binance: "APTUSDT" },
  { symbol: "ARBUSD", asset_class: "crypto", binance: "ARBUSDT" },
  { symbol: "OPUSD", asset_class: "crypto", binance: "OPUSDT" },
  { symbol: "SUIUSD", asset_class: "crypto", binance: "SUIUSDT" },
  { symbol: "SEIUSD", asset_class: "crypto", binance: "SEIUSDT" },
  { symbol: "PYTHUSD", asset_class: "crypto", binance: "PYTHUSDT" },
  { symbol: "RENDERUSD", asset_class: "crypto", binance: "RENDERUSDT" },
  { symbol: "TONUSD", asset_class: "crypto", binance: "TONUSDT" },
  { symbol: "BONKUSD", asset_class: "crypto", binance: "BONKUSDT" },
  { symbol: "PEPEUSD", asset_class: "crypto", binance: "PEPEUSDT" },
  // stocks
  ...
  { symbol: "XAUUSD", asset_class: "forex", yahoo: "XAUUSD=X" },
  { symbol: "XAGUSD", asset_class: "forex", yahoo: "XAGUSD=X" },
  // commodities
